...
async function loadUfwStatus() {
    ...
    tableBody.innerHTML = `<tr><td colspan="6" class="loading" data-label="Status">Carregando...</td></tr>`;
    ...
    try {
        ...
        if (data.rules.length === 0) {
            tableBody.innerHTML = `<tr><td colspan="6" style="text-align: center;">Nenhuma regra salva no banco de dados.</td></tr>`;
        } else {
